...
return [
    ...
    */
    ...
    // This app's full-page layout lives at resources/views/components/layouts/app.blade.php
    // (the Livewire 3 convention), so point at it rather than Livewire 4's new
    // `layouts::app` namespace default (resources/views/layouts/app.blade.php).
