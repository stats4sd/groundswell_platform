 ...
 * Identifiers/properties/GPS are not stored anywhere locally - they live only in ODK
 * Central and are read live via OdkFarmEntityService (no local Entity/EntityValue mirror
 * either - see docs/plans/farm-entities-simplify-and-gps-sync.md).
 */
