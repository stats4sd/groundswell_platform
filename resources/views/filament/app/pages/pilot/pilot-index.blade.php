    ...
    <x-instructions-sidebar>
        ...
        <x-slot:instructions>
            ...
            <div class="mx-12 mb-4">
                ...
                <h5 class="mt-0">{{ t("Pilot test and enumerator training") }}</h5>
                <p class="my-2">
                    {{ t("This page guides you through the process of conducting the pilot test for your survey.") }}
                    {{ t("Before you conduct the pilot, ensure you have:") }}
                </p>
                <ul class="mb-2 ml-12 list-disc">
                    <li class="mb-1">
                        {{ t("Made your intended changes and customisations using the previous steps on the dashboard.") }}
                    </li>
                    <li class="mb-1">
                        {{ t("As needed, used the initial pilot draft versions of the form to check any additional changes, such as the addition of custom questions for your local indicators following the LISP workshop.") }}
                    </li>
                    <li class="mb-1">
                        {{ t("Published all changes to update the forms you will use in the pilot.") }}
                        <br>{{ t("This must be done manually; this is so that you can make changes and test them as draft versions to confirm they are working as expected before updating the versions that your enumerator team will see.") }}
                        {{ t("You will find the option to publish your changes on the 'Access forms' section of the page.") }}
                    </li>
                </ul>
                <p class="mb-2">
                    {{ t("When you are ready for the pilot, you will need to organise the workshop as described in this page. You will find the QR code to allow enumerators to set up the forms on the 'Access forms' section of the page. Note that these are not the same as the draft versions used in the initial pilot, and those draft forms should never be used for this pilot or for live data collection, as the data submitted for those forms is not saved. Ensure that everyone is using the correct version of the forms before proceeding with the pilot or any data collection.") }}
                </p>

                <h5 class="mt-0">{{ t("Access forms") }}</h5>
                <p class="mb-2">
                    {{ t("The 'Access forms' section contains the option to publish your changes to the survey, and QR codes to set up the forms on the mobile devices that will be used to pilot data collection.") }}
                </p>

                <h5 class="mt-0">{{ t("Forms and submissions") }}</h5>
                <p class="mb-2">
                    {{ t("In the 'Forms and submissions' section, you can see an overview of the current forms and view the submissions. If new submissions have not yet appeared on the page, you can use the 'manually get submissions' option on the survey forms view to prompt this to refresh.") }}
                </p>
                <p class="mb-2">
                    {{ t("The survey submissions view shows you all the submissions for your forms. You can view individual submissions to conduct quality checks. This will help you identify frequent errors or omissions which may necessitate further enumerator training or adjustments to the form.") }}
                </p>
                <p class="mb-2">
                    {{ t("When you have completed the pilot, you will likely then need to return to previous sections to make additional edits to the survey. Revisit any section from the dashboard as needed. You may choose to carry out further pilots or technical tests before commencing live data collection.") }}
                </p>
                <h5>{{ t("Mark this section as complete when:") }}</h5>
                <p class="mb-2">
                    {{ t("You have conducted the pilot and training workshop, and are satisfied that the required adjustments have been made.") }}
                </p>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="basis-3/4 pr-12">
                                ...
                                {{ t("If there are changes that can be published, you can do so by clicking the") }}
                                <b>{{ t("Publish") }}</b> {{ t("button on the table below. We highly recommend reviewing the forms as DRAFT versions before publishing. You can do so on the") }}
