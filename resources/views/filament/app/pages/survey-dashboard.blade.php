    ...
    <x-instructions-sidebar :videoUrl="'#'">
        ...
        <x-slot:instructions>
            ...
            <div class="mx-12 mb-4">
                <p class="mb-2">
                    {{ t("This is the HOLPA survey builder dashboard. Here you can see an overview of the tasks required to prepare and deliver the survey, and you can keep track of your progress.") }}
                </p>
                <h5>{{ t("Do I need to complete the sections in order?") }}</h5>
                <p class="mb-2">
                    {{ t("The sections do not have to be completed in order. Although they are in a logical order, most users will probably go back and forth and revisit sections. You can mark sections as complete to keep track of your work, but you can still make changes in a \"completed\" section.") }}
                </p>
                <h5>{{ t("How do I complete a section?") }}</h5>
                <p class="mb-2">
                    {{ t("Within each section, there are usually multiple actions. Most actions will have options to add information or adjust elements of your survey. Some actions are prompts for tasks that take place outside of the tool, such as the local indicator selection workshop. When you are finished with a section, mark it as complete using the button at the bottom of the screen; this will help you and your team keep track of your progress.") }}
                </p>
                <p class="mb-2">
                    {{ t("Each section also has instructions in text and video form.") }}
                </p>

                <h5 class="mb-2">{{ t("What\'s on the dashboard?") }}</h5>
                <p>
                    {{ t("The dashboard contains sections for each of the different tasks that need to be done to prepare and implement HOLPA. They are sorted into headings for different aspects of the process:") }}
                </p>
                <ul class="instructions_list list-disc ">
                    <li>
                        <span class="font-semibold">{{ t("Prepare survey") }}</span><br>
                        {{ t("This is where you indicate the country and language (or languages) in which you will be preparing the survey, and select or provide the translated versions of HOLPA to be used.") }}
                        {{ t("This will generate the forms which you will be customising and using throughout the rest of the process. You will not be able to complete some other steps until you have selected a country, language and translation.") }}
                    </li>
                    <li>
                        <span class="font-semibold">{{ t("Survey locations") }}</span><br>
                        {{ t("Here, you will provide the details of the farms/locations to be visited. This is necessary to allow enumerators to conduct the survey; and possibly for data analysis later on.") }}
                    </li>
                    <li>
                        <span class="font-semibold">{{ t("Localisation") }}</span><br>
                        ...
                        {{ t("These sections are:") }}
                        <ul class="ml-6 " style="  list-style-type: circle;">
                            <li>
                                {{ t("\'Place based adaptations\', which allows you to adjust details of the survey such as a suitable time frame to ask about recent events, and the specific foods, crops, animals and other units which might be asked about, so that the answer options make sense in the context.") }}
                                {{ t("At the end of this section, you are prompted to conduct an initial pilot to check the sense and functionality of the survey.") }}
                            </li>
                            <li>
                                {{ t("The local indicator selection process (LISP), which involves holding a workshop with local farmers and stakeholders to identify a set of contextually-specific indicators to include in the HOLPA tool. You can then add those local indicators into the customised HOLPA tool.") }}
                            </li>
                            <li>
                                {{ t("A full pilot test of the customised HOLPA survey, allowing for quality control and for training of enumerators. After completing these activities, it may be necessary to return to previous sections and make changes to your survey.") }}
                            </li>
                        </ul>
                    ...
                    <li>
                        <span class="font-semibold">{{ t("Data collection") }}</span><br>

                        {{ t("When you commence data collection for your survey, you can monitor, review and edit submissions here.") }}
                    </li>
                    <li>
                        <span class="font-semibold">{{ t("Download data") }}</span><br>

                        {{ t("Quickly retrieve all the data collected for your customised HOLPA survey. From there, you may conduct your own analysis or whatever else you wish to do.") }}
                    </li>
                </ul>
            </div>
        </x-slot:instructions>
